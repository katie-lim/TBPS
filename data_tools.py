...
def split_into_bins(df):
    ...
    # define the ranges of q^2 for each bin, in line with
    # https://mesmith75.github.io/ic-teach-kstmumu-public/predictions/
    bin_ranges = [(0.1, 0.98), (1.1, 2.5), (2.5, 4.0), (4.0, 6.0), (6.0, 8.0), (15.0, 17.0), (17.0, 19.0), (11.0, 12.5), (1.0, 6.0), (15.0, 17.9)]


    bins = [df[(df["q2"] >= bin_range[0]) & (df["q2"] <= bin_range[1])] for bin_range in bin_ranges]
